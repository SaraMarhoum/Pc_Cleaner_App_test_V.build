...
namespace Atelier3
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            string wktA = File.ReadLines(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Analyse.txt").Last();
            ...
            //Display last analyse date in top of app using split read last line
            string wktD = File.ReadLines(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Delete.txt").Last();
                    ...
                    for (int i = 0; i <= fileCount + 1; i++)
                    {
                        ...
                        this.Dispatcher.Invoke(() => //Use Dispather to Update UI Immediately  
                        {
                            ...
                            if (i == (fileCount + 1))
                            {
                                ...
                                File.AppendAllText(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Analyse.txt", "Analyse réalisée le ; " + DateTime.Now.ToString() + Environment.NewLine);
                    ...
                    for (int i = 0; i <= fileCount + 1; i++)
                    {
                        ...
                        this.Dispatcher.Invoke(() => //Use Dispather to Update UI Immediately  
                        {
                            ...
                            if (i == (fileCount + 1))
                            {
                                ...
                                File.AppendAllText(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Delete.txt", "Nettoyage réalisé le ; " + DateTime.Now.ToString() + Environment.NewLine);
        ...
        private void btn_histo1_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Creer Histo
            string[] files = { @"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Analyse.txt", @"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\Delete.txt" };

            FileStream outputFile = new FileStream(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\histo.txt", FileMode.Create);
            ...
            StreamReader sr = new StreamReader(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\histo.txt");
        ...
        private void btn_clear__histo_Click(object sender, RoutedEventArgs e)
        {
            ...
            File.WriteAllText(@"C:\Users\Youcode\source\repos\Atelier3\Atelier3\bin\History\histo.txt", string.Empty);
        }
        ...
        private void btn_majGrid_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!webClient.DownloadString("https://pastebin.com/sWt7jMj3").Contains("v0.0.0"))
            {
                if (System.Windows.Forms.MessageBox.Show("Looks like there is an update! Do you want to download it?", "Demo", MessageBoxButtons.YesNo,
                    ...
                    {
                        Process.Start(@"C:\Users\Youcode\source\repos\Atelier3\SmartScanUpdater\bin\Release\SmartScanUpdater.exe");
